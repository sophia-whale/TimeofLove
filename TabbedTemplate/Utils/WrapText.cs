...
namespace TabbedTemplate.Utils
{
    public class WrapText
    {
        ...
        public static List<string> Split(string str)
        {
            ...
            var line2 = line1.SelectMany((o, _) => Regex.Split(o, bracketsBegin)).ToList();
            var line3 = line2.SelectMany((o, _) => Regex.Split(o, bracketsEnd)).ToList();
            var words = line3.Where(o => !string.IsNullOrEmpty(o)).ToList();
            ...
            words.ForEach(word =>
            {
                ...
                var token = Regex.IsMatch(word, periods);
