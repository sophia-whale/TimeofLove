...
{
    /// <summary>
    /// ItemTappedEventArgs到纪念日转换器
    /// </summary>
    public class ItemTappedEventArgsToMemorialDayConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter,
            CultureInfo culture) => (value as ItemTappedEventArgs)?.Item as MemorialDay;
