...
{
    public class SKPaintSurfaceEventArgsToItemConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter,
            CultureInfo culture)
        {
            var surface = (value as SKPaintSurfaceEventArgs)?.Surface;
            var info = (SKImageInfo)((value as SKPaintSurfaceEventArgs)?.Info);
            SKEventItem skEventItem =
                new SKEventItem { Surface = surface, Info = info };
            return skEventItem;
        }
